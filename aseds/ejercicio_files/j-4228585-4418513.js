//Generated:2023-08-25 01:18:36// 6-274
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4228585 || '',
    guid: window.ftGUID_4228585 || '',
    confID: window.ftConfID_4228585 || '0',
    ftReturn: window.ftReturn_4228585 || '',
    keyword: window.ftKeyword_4228585 || '',
    ftId: window.ftId_4228585 || '',
    ftImpId: window.ftImp4228585 && window.ftImp4228585.impID || '',
    gdpr: window.ftImp4228585 && window.ftImp4228585.gdpr || '',
    gdpr_consent: window.ftImp4228585 && window.ftImp4228585.gdpr_consent || '',
    gdpr_pd: window.ftImp4228585 && window.ftImp4228585.gdpr_pd || '',
    us_privacy: window.ftImp4228585 && window.ftImp4228585.us_privacy || '',
    campaignID: '115975',
    cID: '155251',
    pID: '4228585',
    creativeID: '4418513',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115975&sid=18330&plc=4228585&num=&adid=&advid=&adsrv=29&btreg=4228585&btadsrv=flashtalking&crt=4418513&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115975;4228585;4418513;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/la/creativecloud/buy/students.html?sdid=1NZGD4KZ&mv=display&mv2=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?226137983-4228585;4418513;',
    centreAd: false,
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/422/4228585/4418513/image/4418513.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115975;4228585;202;pixel;DV360;DV360FY20EDUPSPAudExCODSKBAN300x600/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115975;4228585;4418513;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/la/creativecloud/buy/students.html?sdid=1NZGD4KZ&mv=display&mv2=display",
    divID: 'ftdiv4228585',
    altimgID: 'ftalt4228585',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4228585 && parseInt(window.ftImp4228585.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4228585') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4228585'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4228585").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4228585").style.display = "none";
		    }
		});
	}
}(ft4228585));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115975&l2=DV360&l3=4228585&l4=4418513&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115975&l2=DV360&l3=4228585&l4=4418513&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4228585;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4228585;
